...
export const Key: FC<Props> = ({ apiKey, onApiKeyChange }) => {
  ...
  return isChanging ? (
    <div className="duration:200 flex w-full cursor-pointer items-center rounded-md py-3 px-3 transition-colors hover:bg-gray-500/10">
      ...
      <input
        ref={inputRef}
        className="ml-2 h-[20px] flex-1 overflow-hidden overflow-ellipsis border-b border-neutral-400 bg-transparent
        pr-1 text-[12.5px] leading-3 text-left text-black dark:text-white outline-none focus:border-neutral-100"
        type="password"
        value={newKey}
